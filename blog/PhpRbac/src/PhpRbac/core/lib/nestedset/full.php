...
class FullNestedSet extends BaseNestedSet implements ExtendedNestedSet
{
    ...
    **/
     ...
     */
    // smj
    function siblingConditional($SiblingDistance=1,$ConditionString=null,$Rest=null)
    {
        $Arguments=func_get_args();
     ...
     */
    // smj
    function descendantsConditional($AbsoluteDepths=false,$ConditionString=null,$Rest=null)
    {
        if (!$AbsoluteDepths)
